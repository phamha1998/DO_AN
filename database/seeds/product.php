...
class product extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('product')->insert([
            ...
            ['id'=>3,'product_code'=>'SP03','name'=>'Quần âu nam','price'=>500000,'featured'=>0,'state'=>1,'img'=>'no-img.jpg','category_id'=>3],
            ['id'=>4,'product_code'=>'SP04','name'=>'Áo nữ có cổ viền tay xinh xinh','price'=>500000,'featured'=>1,'state'=>1,'img'=>'no-img.jpg','category_id'=>3],
